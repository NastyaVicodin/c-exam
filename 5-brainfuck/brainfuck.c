...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/11/26 12:36:52 by alukyane          #+#    #+#             */
/*   Updated: 2017/11/26 14:54:18 by alukyane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <unistd.h>

void	ft_brainfuck(char *str, char *out, int i)
{
	while (*str)
	{
		i = 1;
...
"+++++[>++sefs++[>++sef+dht+>+++++sfsfefijdgj<<-]>>>++efn<<<<-]>>esf-----sf---.>+++++.>."
Hi$
